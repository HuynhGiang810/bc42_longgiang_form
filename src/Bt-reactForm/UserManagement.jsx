...
function UserManagement() {
  ...
  // Hàm call API để lấy danh sách products
  ...
  const handleDeleteProduct = async (productId) => {
    ...
    try {
      ...
      // Gọi lại hàm fetchProducts để gọi API lấy danh sách products mới nhất và set lại cho state products
      fetchProducts();
    } catch (error) {
      console.log(error);
    }
  ...
  // Hàm xử lý nhận vào giá trị searchString
  ...
  return (
    <div className='container-fluid'>
      <h1 className='text-center text-primary'>Quản lý sản phẩm</h1>
      <div className="card">
        <div className="card-header bg-dark text-white">Thêm sản phẩm</div>
